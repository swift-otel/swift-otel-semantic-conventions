    ...
    public struct AspnetcoreAttributes: SpanAttributeNamespace {
        ...
        public struct DiagnosticsAttributes: SpanAttributeNamespace {
            ...
            public struct ExceptionAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `handled`
                    ///     - `unhandled`
                    public var result: Self.Key<ResultEnum> {
                        .init(name: OTelAttribute.aspnetcore.diagnostics.exception.result)
                    }

                    public struct ResultEnum: SpanAttributeConvertible, Sendable {
            ...
            public struct HandlerAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var `type`: Self.Key<String> {
                        .init(name: OTelAttribute.aspnetcore.diagnostics.handler.`type`)
                    }
                }
            }
        }
        ...
        public struct RoutingAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `success`
                ///     - `failure`
                public var matchStatus: Self.Key<MatchStatusEnum> {
                    .init(name: OTelAttribute.aspnetcore.routing.matchStatus)
                }

                public struct MatchStatusEnum: SpanAttributeConvertible, Sendable {
                    private let rawValue: String
                    /// `success`: Match succeeded
