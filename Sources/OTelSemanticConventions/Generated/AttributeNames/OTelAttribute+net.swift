...
extension OTelAttribute {
    ...
    public enum net {
        ...
        @available(*, deprecated, renamed: "OTelAttribute.network.transport")
        ...
        public enum host {
            ...
            /// - Type: int
            /// - Example: `8080`
            @available(*, deprecated, renamed: "OTelAttribute.server.port")
        ...
        public enum `protocol` {
            ...
            /// - Type: string
            /// - Example: `3.1.1`
            @available(*, deprecated, renamed: "OTelAttribute.network.protocol.version")
        ...
        public enum sock {
            ...
            public enum host {
                ...
                /// - Type: int
                /// - Example: `8080`
                @available(*, deprecated, renamed: "OTelAttribute.network.local.port")
            ...
            public enum peer {
                ...
                /// - Type: int
                /// - Example: `65531`
                @available(*, deprecated, renamed: "OTelAttribute.network.peer.port")
