...
extension SpanAttributes {
    ...
    public struct ExceptionAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var escaped: Self.Key<Bool> { .init(name: OTelConventions.exception.escaped) }
            ...
            public var message: Self.Key<String> { .init(name: OTelConventions.exception.message) }
            ...
            /// `
            public var stacktrace: Self.Key<String> { .init(name: OTelConventions.exception.stacktrace) }
            ...
            ///     - `OSError`
            public var type: Self.Key<String> { .init(name: OTelConventions.exception.type) }
        }
