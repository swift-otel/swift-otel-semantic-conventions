...
extension SpanAttributes {
    ...
    public struct ContainerAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var command: Self.Key<String> { .init(name: OTelAttributes.container.command) }
            ...
            /// 
            /// - Type: stringArray
            public var command_args: Self.Key<[String]> { .init(name: OTelAttributes.container.command_args) }
            ...
            public var command_line: Self.Key<String> { .init(name: OTelAttributes.container.command_line) }
            ...
            public var id: Self.Key<String> { .init(name: OTelAttributes.container.id) }
            ...
            public var name: Self.Key<String> { .init(name: OTelAttributes.container.name) }
            ...
            ///     - `containerd`
            ///     - `rkt`
            public var runtime: Self.Key<String> { .init(name: OTelAttributes.container.runtime) }
        }
        ...
        public struct CsiAttributes: SpanAttributeNamespace {
            ...
            public struct PluginAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var name: Self.Key<String> { .init(name: OTelAttributes.container.csi.plugin.name) }
                }
            ...
            public struct VolumeAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var id: Self.Key<String> { .init(name: OTelAttributes.container.csi.volume.id) }
                }
        ...
        public struct ImageAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: Self.Key<String> { .init(name: OTelAttributes.container.image.id) }
                ...
                public var name: Self.Key<String> { .init(name: OTelAttributes.container.image.name) }
                ...
                public var repo_digests: Self.Key<[String]> { .init(name: OTelAttributes.container.image.repo_digests) }
                ...
                /// 
                /// - Type: stringArray
                public var tags: Self.Key<[String]> { .init(name: OTelAttributes.container.image.tags) }
            }
