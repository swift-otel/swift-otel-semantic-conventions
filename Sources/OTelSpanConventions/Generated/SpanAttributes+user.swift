...
extension SpanAttributes {
    ...
    public struct UserAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var email: Self.Key<String> { .init(name: OTelAttribute.user.email) }
            ...
            public var hash: Self.Key<String> { .init(name: OTelAttribute.user.hash) }
            ...
            public var id: Self.Key<String> { .init(name: OTelAttribute.user.id) }
            ...
            /// 
            /// - Example: `a.einstein`
            public var name: Self.Key<String> { .init(name: OTelAttribute.user.name) }
            ...
            /// 
            /// - Type: stringArray
            public var roles: Self.Key<[String]> { .init(name: OTelAttribute.user.roles) }
        }
