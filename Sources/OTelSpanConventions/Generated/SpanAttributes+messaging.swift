...
extension SpanAttributes {
    ...
    public struct MessagingAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var clientId: Self.Key<String> { .init(name: OTelAttribute.messaging.clientId) }
            ...
            public var _operation: Self.Key<String> { .init(name: OTelAttribute.messaging._operation) }
            ...
            public var system: Self.Key<SystemEnum> { .init(name: OTelAttribute.messaging.system) }
            ...
            public struct SystemEnum: SpanAttributeConvertible {
                ...
                /// `aws_sqs`: Amazon Simple Queue Service (SQS)
                public static let awsSqs = Self.init(rawValue: "aws_sqs")
                /// `eventgrid`: Azure Event Grid
                ...
                /// `gcp_pubsub`: Google Cloud Pub/Sub
                public static let gcpPubsub = Self.init(rawValue: "gcp_pubsub")
                /// `jms`: Java Message Service
        ...
        public struct BatchAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `1`
                ///     - `2`
                public var messageCount: Self.Key<Int> { .init(name: OTelAttribute.messaging.batch.messageCount) }
            }
        ...
        public struct ClientAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `client-5`
                ///     - `myhost@8742@s8083jm`
                public var id: Self.Key<String> { .init(name: OTelAttribute.messaging.client.id) }
            }
        ...
        public struct ConsumerAttributes: SpanAttributeNamespace {
            ...
            public struct GroupAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `my-group`
                    ///     - `indexer`
                    public var name: Self.Key<String> { .init(name: OTelAttribute.messaging.consumer.group.name) }
                }
        ...
        public struct DestinationAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Type: boolean
                public var anonymous: Self.Key<Bool> { .init(name: OTelAttribute.messaging.destination.anonymous) }
                ...
                ///     - `MyQueue`
                ///     - `MyTopic`
                public var name: Self.Key<String> { .init(name: OTelAttribute.messaging.destination.name) }
                ...
                public var template: Self.Key<String> { .init(name: OTelAttribute.messaging.destination.template) }
                ...
                /// 
                /// - Type: boolean
                public var temporary: Self.Key<Bool> { .init(name: OTelAttribute.messaging.destination.temporary) }
            }
            ...
            public struct PartitionAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `1`
                    public var id: Self.Key<String> { .init(name: OTelAttribute.messaging.destination.partition.id) }
                }
            ...
            public struct SubscriptionAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var name: Self.Key<String> { .init(name: OTelAttribute.messaging.destination.subscription.name) }
                }
        ...
        public struct DestinationPublishAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var anonymous: Self.Key<Bool> { .init(name: OTelAttribute.messaging.destinationPublish.anonymous) }
                ...
                ///     - `MyTopic`
                @available(*, deprecated, message: "No replacement at this time.")
                public var name: Self.Key<String> { .init(name: OTelAttribute.messaging.destinationPublish.name) }
            }
        ...
        public struct EventhubsAttributes: SpanAttributeNamespace {
            ...
            public struct ConsumerAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var group: Self.Key<String> { .init(name: OTelAttribute.messaging.eventhubs.consumer.group) }
                }
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `1701393730`
                    public var enqueuedTime: Self.Key<Int> { .init(name: OTelAttribute.messaging.eventhubs.message.enqueuedTime) }
                }
        ...
        public struct GcpPubsubAttributes: SpanAttributeNamespace {
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `10`
                    public var ackDeadline: Self.Key<Int> { .init(name: OTelAttribute.messaging.gcpPubsub.message.ackDeadline) }
                    ...
                    /// 
                    /// - Example: `ack_id`
                    public var ackId: Self.Key<String> { .init(name: OTelAttribute.messaging.gcpPubsub.message.ackId) }
                    ...
                    /// 
                    /// - Example: `2`
                    public var deliveryAttempt: Self.Key<Int> { .init(name: OTelAttribute.messaging.gcpPubsub.message.deliveryAttempt) }
                    ...
                    public var orderingKey: Self.Key<String> { .init(name: OTelAttribute.messaging.gcpPubsub.message.orderingKey) }
                }
        ...
        public struct KafkaAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `42`
                public var offset: Self.Key<Int> { .init(name: OTelAttribute.messaging.kafka.offset) }
            }
            ...
            public struct ConsumerAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// - Example: `my-group`
                    @available(*, deprecated, message: "Replaced by `messaging.consumer.group.name`.")
                    public var group: Self.Key<String> { .init(name: OTelAttribute.messaging.kafka.consumer.group) }
                }
            ...
            public struct DestinationAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var partition: Self.Key<Int> { .init(name: OTelAttribute.messaging.kafka.destination.partition) }
                }
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `myKey`
                    public var key: Self.Key<String> { .init(name: OTelAttribute.messaging.kafka.message.key) }
                    ...
                    public var offset: Self.Key<Int> { .init(name: OTelAttribute.messaging.kafka.message.offset) }
                    ...
                    /// 
                    /// - Type: boolean
                    public var tombstone: Self.Key<Bool> { .init(name: OTelAttribute.messaging.kafka.message.tombstone) }
                }
        ...
        public struct MessageAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var conversationId: Self.Key<String> { .init(name: OTelAttribute.messaging.message.conversationId) }
                ...
                public var id: Self.Key<String> { .init(name: OTelAttribute.messaging.message.id) }
            }
            ...
            public struct BodyAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `1439`
                    public var size: Self.Key<Int> { .init(name: OTelAttribute.messaging.message.body.size) }
                }
            ...
            public struct EnvelopeAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `2738`
                    public var size: Self.Key<Int> { .init(name: OTelAttribute.messaging.message.envelope.size) }
                }
        ...
        public struct OperationAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `nack`
                ///     - `send`
                public var name: Self.Key<String> { .init(name: OTelAttribute.messaging.operation.name) }
                ...
                public var `type`: Self.Key<TypeEnum> { .init(name: OTelAttribute.messaging.operation.`type`) }
        ...
        public struct RabbitmqAttributes: SpanAttributeNamespace {
            ...
            public struct DestinationAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `myKey`
                    public var routingKey: Self.Key<String> { .init(name: OTelAttribute.messaging.rabbitmq.destination.routingKey) }
                }
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `123`
                    public var deliveryTag: Self.Key<Int> { .init(name: OTelAttribute.messaging.rabbitmq.message.deliveryTag) }
                }
        ...
        public struct RocketmqAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var clientGroup: Self.Key<String> { .init(name: OTelAttribute.messaging.rocketmq.clientGroup) }
                ...
                public var consumptionModel: Self.Key<ConsumptionModelEnum> { .init(name: OTelAttribute.messaging.rocketmq.consumptionModel) }
                
                public struct ConsumptionModelEnum: SpanAttributeConvertible {
                    private let rawValue: String
                    /// `clustering`: Clustering consumption model
                ...
                /// 
                /// - Example: `myNamespace`
                public var namespace: Self.Key<String> { .init(name: OTelAttribute.messaging.rocketmq.namespace) }
            }
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `3`
                    public var delayTimeLevel: Self.Key<Int> { .init(name: OTelAttribute.messaging.rocketmq.message.delayTimeLevel) }
                    ...
                    public var deliveryTimestamp: Self.Key<Int> { .init(name: OTelAttribute.messaging.rocketmq.message.deliveryTimestamp) }
                    ...
                    public var group: Self.Key<String> { .init(name: OTelAttribute.messaging.rocketmq.message.group) }
                    ...
                    /// 
                    /// - Type: stringArray
                    public var keys: Self.Key<[String]> { .init(name: OTelAttribute.messaging.rocketmq.message.keys) }
                    ...
                    /// 
                    /// - Example: `tagA`
                    public var tag: Self.Key<String> { .init(name: OTelAttribute.messaging.rocketmq.message.tag) }
                    ...
                    public var `type`: Self.Key<TypeEnum> { .init(name: OTelAttribute.messaging.rocketmq.message.`type`) }
        ...
        public struct ServicebusAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var dispositionStatus: Self.Key<DispositionStatusEnum> { .init(name: OTelAttribute.messaging.servicebus.dispositionStatus) }
                
                public struct DispositionStatusEnum: SpanAttributeConvertible {
                    private let rawValue: String
                    /// `complete`: Message is completed
                    ...
                    /// `dead_letter`: Message is sent to dead letter queue
                    public static let deadLetter = Self.init(rawValue: "dead_letter")
                    /// `defer`: Message is deferred
            ...
            public struct DestinationAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var subscriptionName: Self.Key<String> { .init(name: OTelAttribute.messaging.servicebus.destination.subscriptionName) }
                }
            ...
            public struct MessageAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `2`
                    public var deliveryCount: Self.Key<Int> { .init(name: OTelAttribute.messaging.servicebus.message.deliveryCount) }
                    ...
                    /// 
                    /// - Example: `1701393730`
                    public var enqueuedTime: Self.Key<Int> { .init(name: OTelAttribute.messaging.servicebus.message.enqueuedTime) }
                }
