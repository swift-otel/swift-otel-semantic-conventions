...
extension SpanAttributes {
    ...
    public struct TlsAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var cipher: Self.Key<String> { .init(name: OTelAttribute.tls.cipher) }
            ...
            /// 
            /// - Example: `secp256r1`
            public var curve: Self.Key<String> { .init(name: OTelAttribute.tls.curve) }
            ...
            /// 
            /// - Example: `true`
            public var established: Self.Key<Bool> { .init(name: OTelAttribute.tls.established) }
            ...
            /// 
            /// - Example: `true`
            public var resumed: Self.Key<Bool> { .init(name: OTelAttribute.tls.resumed) }
        }
        ...
        public struct ClientAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `MII...`
                public var certificate: Self.Key<String> { .init(name: OTelAttribute.tls.client.certificate) }
                ...
                public var issuer: Self.Key<String> { .init(name: OTelAttribute.tls.client.issuer) }
                ...
                public var ja3: Self.Key<String> { .init(name: OTelAttribute.tls.client.ja3) }
                ...
                public var subject: Self.Key<String> { .init(name: OTelAttribute.tls.client.subject) }
            ...
            public struct HashAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var md5: Self.Key<String> { .init(name: OTelAttribute.tls.client.hash.md5) }
                    ...
                    public var sha1: Self.Key<String> { .init(name: OTelAttribute.tls.client.hash.sha1) }
                    ...
                    public var sha256: Self.Key<String> { .init(name: OTelAttribute.tls.client.hash.sha256) }
                }
        ...
        public struct ServerAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `MII...`
                public var certificate: Self.Key<String> { .init(name: OTelAttribute.tls.server.certificate) }
                ...
                /// 
                /// - Example: `CN=Example Root CA, OU=Infrastructure Team, DC=example, DC=com`
                public var issuer: Self.Key<String> { .init(name: OTelAttribute.tls.server.issuer) }
                ...
                /// 
                /// - Example: `d4e5b18d6b55c71272893221c96ba240`
                public var ja3s: Self.Key<String> { .init(name: OTelAttribute.tls.server.ja3s) }
                ...
                public var subject: Self.Key<String> { .init(name: OTelAttribute.tls.server.subject) }
            }
            ...
            public struct HashAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `0F76C7F2C55BFD7D8E8B8F4BFBF0C9EC`
                    public var md5: Self.Key<String> { .init(name: OTelAttribute.tls.server.hash.md5) }
                    ...
                    /// 
                    /// - Example: `9E393D93138888D288266C2D915214D1D1CCEB2A`
                    public var sha1: Self.Key<String> { .init(name: OTelAttribute.tls.server.hash.sha1) }
                    ...
                    /// 
                    /// - Example: `0687F666A054EF17A08E2F2162EAB4CBC0D265E1D7875BE74BF3C712CA92DAF0`
                    public var sha256: Self.Key<String> { .init(name: OTelAttribute.tls.server.hash.sha256) }
                }
