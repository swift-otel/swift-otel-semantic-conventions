...
extension SpanAttributes {
    ...
    public struct UrlAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var domain: Self.Key<String> { .init(name: OTelAttribute.url.domain) }
            ...
            ///     - `png`
            ///     - `gz`
            public var `extension`: Self.Key<String> { .init(name: OTelAttribute.url.`extension`) }
            ...
            public var original: Self.Key<String> { .init(name: OTelAttribute.url.original) }
            ...
            /// 
            /// - Example: `443`
            public var port: Self.Key<Int> { .init(name: OTelAttribute.url.port) }
            ...
            ///     - `east`
            ///     - `sub2.sub1`
            public var subdomain: Self.Key<String> { .init(name: OTelAttribute.url.subdomain) }
            ...
            ///     - `/users/:id`
            ///     - `/users?id={id}`
            public var template: Self.Key<String> { .init(name: OTelAttribute.url.template) }
