    ...
    public struct CloudfoundryAttributes: SpanAttributeNamespace {
        ...
        public struct AppAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: Self.Key<String> { .init(name: OTelAttribute.cloudfoundry.app.id) }
                ...
                /// 
                /// - Example: `my-app-name`
                public var name: Self.Key<String> { .init(name: OTelAttribute.cloudfoundry.app.name) }
            }
            ...
            public struct InstanceAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `0`
                    ///     - `1`
                    public var id: Self.Key<String> { .init(name: OTelAttribute.cloudfoundry.app.instance.id) }
                }
        ...
        public struct OrgAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `218fc5a9-a5f1-4b54-aa05-46717d0ab26d`
                public var id: Self.Key<String> { .init(name: OTelAttribute.cloudfoundry.org.id) }
                ...
                /// 
                /// - Example: `my-org-name`
                public var name: Self.Key<String> { .init(name: OTelAttribute.cloudfoundry.org.name) }
            }
        ...
        public struct ProcessAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `218fc5a9-a5f1-4b54-aa05-46717d0ab26d`
                public var id: Self.Key<String> { .init(name: OTelAttribute.cloudfoundry.process.id) }
        ...
        public struct SpaceAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `218fc5a9-a5f1-4b54-aa05-46717d0ab26d`
                public var id: Self.Key<String> { .init(name: OTelAttribute.cloudfoundry.space.id) }
                ...
                public var name: Self.Key<String> { .init(name: OTelAttribute.cloudfoundry.space.name) }
            }
        ...
        public struct SystemAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `cf/gorouter`
                public var id: Self.Key<String> { .init(name: OTelAttribute.cloudfoundry.system.id) }
            }
            ...
            public struct InstanceAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// 
                    /// - Example: `218fc5a9-a5f1-4b54-aa05-46717d0ab26d`
                    public var id: Self.Key<String> { .init(name: OTelAttribute.cloudfoundry.system.instance.id) }
                }
