...
extension SpanAttributes {
    ...
    public struct LogAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var iostream: Self.Key<IostreamEnum> { .init(name: OTelAttribute.log.iostream) }
        ...
        public struct FileAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `audit.log`
                public var name: Self.Key<String> { .init(name: OTelAttribute.log.file.name) }
                ...
                public var path: Self.Key<String> { .init(name: OTelAttribute.log.file.path) }
        ...
        public struct RecordAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var original: Self.Key<String> { .init(name: OTelAttribute.log.record.original) }
                ...
                public var uid: Self.Key<String> { .init(name: OTelAttribute.log.record.uid) }
            }
