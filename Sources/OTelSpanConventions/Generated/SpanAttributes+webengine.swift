...
extension SpanAttributes {
    ...
    public struct WebengineAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var description: Self.Key<String> { .init(name: OTelAttribute.webengine.description) }
            ...
            /// 
            /// - Example: `WildFly`
            public var name: Self.Key<String> { .init(name: OTelAttribute.webengine.name) }
            ...
            /// 
            /// - Example: `21.0.0`
            public var version: Self.Key<String> { .init(name: OTelAttribute.webengine.version) }
        }
