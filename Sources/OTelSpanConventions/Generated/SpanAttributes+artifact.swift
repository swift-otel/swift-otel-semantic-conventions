...
extension SpanAttributes {
    ...
    public struct ArtifactAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var filename: Self.Key<String> { .init(name: OTelAttribute.artifact.filename) }
            ...
            public var hash: Self.Key<String> { .init(name: OTelAttribute.artifact.hash) }
            ...
            ///     - `pkg:npm/foo@12.12.3`
            public var purl: Self.Key<String> { .init(name: OTelAttribute.artifact.purl) }
            ...
            ///     - `1.2.1`
            ///     - `122691-build`
            public var version: Self.Key<String> { .init(name: OTelAttribute.artifact.version) }
        }
        ...
        public struct AttestationAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var filename: Self.Key<String> { .init(name: OTelAttribute.artifact.attestation.filename) }
                ...
                public var hash: Self.Key<String> { .init(name: OTelAttribute.artifact.attestation.hash) }
                ...
                /// 
                /// - Example: `123`
                public var id: Self.Key<String> { .init(name: OTelAttribute.artifact.attestation.id) }
            }
