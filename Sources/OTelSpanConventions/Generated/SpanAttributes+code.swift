...
extension SpanAttributes {
    ...
    public struct CodeAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            /// 
            /// - Example: `16`
            public var column: Self.Key<Int> { .init(name: OTelAttribute.code.column) }
            ...
            public var filepath: Self.Key<String> { .init(name: OTelAttribute.code.filepath) }
            ...
            public var function: Self.Key<String> { .init(name: OTelAttribute.code.function) }
            ...
            /// 
            /// - Example: `42`
            public var lineno: Self.Key<Int> { .init(name: OTelAttribute.code.lineno) }
            ...
            public var namespace: Self.Key<String> { .init(name: OTelAttribute.code.namespace) }
