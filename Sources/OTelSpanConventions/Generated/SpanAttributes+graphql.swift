...
extension SpanAttributes {
    ...
    public struct GraphqlAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var document: Self.Key<String> { .init(name: OTelAttribute.graphql.document) }
        }
        ...
        public struct OperationAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var name: Self.Key<String> { .init(name: OTelAttribute.graphql.operation.name) }
