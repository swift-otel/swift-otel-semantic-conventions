...
extension SpanAttributes {
    ...
    public struct FileAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var accessed: Self.Key<String> { .init(name: OTelAttribute.file.accessed) }
            ...
            public var attributes: Self.Key<[String]> { .init(name: OTelAttribute.file.attributes) }
            ...
            /// 
            /// - Example: `2021-01-01T12:00:00Z`
            public var changed: Self.Key<String> { .init(name: OTelAttribute.file.changed) }
            ...
            /// 
            /// - Example: `2021-01-01T12:00:00Z`
            public var created: Self.Key<String> { .init(name: OTelAttribute.file.created) }
            ...
            public var directory: Self.Key<String> { .init(name: OTelAttribute.file.directory) }
            ...
            ///     - `png`
            ///     - `gz`
            public var `extension`: Self.Key<String> { .init(name: OTelAttribute.file.`extension`) }
            ...
            /// 
            /// - Example: `256383`
            public var inode: Self.Key<String> { .init(name: OTelAttribute.file.inode) }
            ...
            /// 
            /// - Example: `0640`
            public var mode: Self.Key<String> { .init(name: OTelAttribute.file.mode) }
            ...
            /// 
            /// - Example: `2021-01-01T12:00:00Z`
            public var modified: Self.Key<String> { .init(name: OTelAttribute.file.modified) }
            ...
            /// 
            /// - Example: `example.png`
            public var name: Self.Key<String> { .init(name: OTelAttribute.file.name) }
            ...
            public var path: Self.Key<String> { .init(name: OTelAttribute.file.path) }
            ...
            /// 
            /// - Type: int
            public var size: Self.Key<Int> { .init(name: OTelAttribute.file.size) }
        }
        ...
        public struct GroupAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `1000`
                public var id: Self.Key<String> { .init(name: OTelAttribute.file.group.id) }
                ...
                /// 
                /// - Example: `users`
                public var name: Self.Key<String> { .init(name: OTelAttribute.file.group.name) }
            }
        ...
        public struct OwnerAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// 
                /// - Example: `1000`
                public var id: Self.Key<String> { .init(name: OTelAttribute.file.owner.id) }
                ...
                /// 
                /// - Example: `root`
                public var name: Self.Key<String> { .init(name: OTelAttribute.file.owner.name) }
            }
