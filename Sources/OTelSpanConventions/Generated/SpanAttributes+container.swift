...
extension SpanAttributes {
    ...
    public struct ContainerAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var command: Self.Key<String> { .init(name: OTelAttribute.container.command) }
            ...
            /// 
            /// - Type: stringArray
            public var command_args: Self.Key<[String]> { .init(name: OTelAttribute.container.command_args) }
            ...
            public var command_line: Self.Key<String> { .init(name: OTelAttribute.container.command_line) }
            ...
            public var id: Self.Key<String> { .init(name: OTelAttribute.container.id) }
            ...
            public var name: Self.Key<String> { .init(name: OTelAttribute.container.name) }
            ...
            ///     - `containerd`
            ///     - `rkt`
            public var runtime: Self.Key<String> { .init(name: OTelAttribute.container.runtime) }
        }
        ...
        public struct CpuAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var state: Self.Key<StateEnum> { .init(name: OTelAttribute.container.cpu.state) }
        ...
        public struct CsiAttributes: SpanAttributeNamespace {
            ...
            public struct PluginAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var name: Self.Key<String> { .init(name: OTelAttribute.container.csi.plugin.name) }
                }
            ...
            public struct VolumeAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var id: Self.Key<String> { .init(name: OTelAttribute.container.csi.volume.id) }
                }
        ...
        public struct ImageAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: Self.Key<String> { .init(name: OTelAttribute.container.image.id) }
                ...
                public var name: Self.Key<String> { .init(name: OTelAttribute.container.image.name) }
                ...
                public var repo_digests: Self.Key<[String]> { .init(name: OTelAttribute.container.image.repo_digests) }
                ...
                /// 
                /// - Type: stringArray
                public var tags: Self.Key<[String]> { .init(name: OTelAttribute.container.image.tags) }
            }
