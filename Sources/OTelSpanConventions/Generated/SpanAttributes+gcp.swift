    ...
    public struct GcpAttributes: SpanAttributeNamespace {
        ...
        public struct ClientAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `alloydb`
                ///     - `spanner`
                public var service: Self.Key<String> { .init(name: OTelAttribute.gcp.client.service) }
            }
        ...
        public struct GceAttributes: SpanAttributeNamespace {
            ...
            public struct InstanceAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    public var hostname: Self.Key<String> { .init(name: OTelAttribute.gcp.gce.instance.hostname) }
                    ...
                    ///     - `instance-1`
                    ///     - `my-vm-name`
                    public var name: Self.Key<String> { .init(name: OTelAttribute.gcp.gce.instance.name) }
                }
