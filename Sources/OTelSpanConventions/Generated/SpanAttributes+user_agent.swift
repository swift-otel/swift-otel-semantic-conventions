...
extension SpanAttributes {
    ...
    public struct UserAgentAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///     - `Safari`
            ///     - `YourApp`
            public var name: Self.Key<String> { .init(name: OTelAttribute.user_agent.name) }
            ...
            public var original: Self.Key<String> { .init(name: OTelAttribute.user_agent.original) }
            ...
            ///     - `14.1.2`
            ///     - `1.0.0`
            public var version: Self.Key<String> { .init(name: OTelAttribute.user_agent.version) }
        }
        ...
        public struct SyntheticAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var type: Self.Key<TypeEnum> { .init(name: OTelAttribute.user_agent.synthetic.type) }
                
                public struct TypeEnum: SpanAttributeConvertible {
                    private let rawValue: String
                    /// `bot`: Bot source.
                    public static let bot = Self.init(rawValue: "bot")
                    /// `test`: Synthetic test source.
