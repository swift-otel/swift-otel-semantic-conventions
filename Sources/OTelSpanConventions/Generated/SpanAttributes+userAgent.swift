...
extension SpanAttributes {
    ...
    public struct UserAgentAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            ///     - `Safari`
            ///     - `YourApp`
            public var name: Self.Key<String> { .init(name: OTelAttribute.userAgent.name) }
            ...
            ///     - `14.1.2`
            ///     - `1.0.0`
            public var version: Self.Key<String> { .init(name: OTelAttribute.userAgent.version) }
        }
        ...
        public struct SyntheticAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var `type`: Self.Key<TypeEnum> { .init(name: OTelAttribute.userAgent.synthetic.`type`) }
